...
parser.add_option('--mysimplebp', action="store_true")
parser.add_option('--localbp', action="store_true")
parser.add_option('--tournamentbp', action="store_true")
parser.add_option('--perceptronsbp', action="store_true")
parser.add_option('--multiper', action="store_true")
