...
parser.add_option('--FIFORP', action="store_true")
parser.add_option('--LRURP', action="store_true")
parser.add_option('--MRURP', action="store_true")
parser.add_option('--MyMRURP', action="store_true")
parser.add_option('--RandomRP', action="store_true")

parser.add_option('--mm', action="store_true")
